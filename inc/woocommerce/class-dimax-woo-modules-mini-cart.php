...
class Mini_Cart {
	 ...
	 */
	function cart_modal() {
		if ( ! in_array( 'cart', \Dimax\Theme::instance()->get_prop( 'modals' ) ) ) {
	...
	public function update_cart_item() {
		...
		check_admin_referer( 'dimax-update-cart-qty--' . $cart_item_key, 'security' );
	...
	public function button_view_cart() {
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward dimax-button">' . esc_html__( 'View cart', 'dimax' ) . '</a>';
	}
	...
	public function button_proceed_to_checkout() {
		echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward dimax-button button-outline">' . esc_html__( 'Checkout', 'dimax' ) . '</a>';
	}
