...
class Dynamic_CSS {
	...
	public function __construct() {
		add_action( 'dimax_wc_inline_style', array( $this, 'add_static_css' ) );
	}
	...
	public function product_badges_static_css() {
		...
		// Product badges.
		if ( ( $bg = \Dimax\Helper::get_option( 'shop_badge_sale_bg' ) ) && $bg != '' ) {
	...
	public function catalog_page_header_static_css() {
		...
		if ( $padding_top && $padding_top != '0' ) {
			$static_css .= '.dimax-catalog-page .catalog-page-header--layout-1 .page-header__title {padding-top: ' . $padding_top . 'px}';
			$static_css .= '.dimax-catalog-page .catalog-page-header--layout-2 {padding-top: ' . $padding_top . 'px}';
		}

		if ( $padding_bottom && $padding_bottom != '0' ) {
			$static_css .= '.dimax-catalog-page .catalog-page-header--layout-1 .page-header__title {padding-bottom: ' . $padding_bottom . 'px}';
			$static_css .= '.dimax-catalog-page .catalog-page-header--layout-2 {padding-bottom: ' . $padding_bottom . 'px}';
		}
	...
	public function product_loop_buttons_static_css() {
		$static_css = '';
		if ( \Dimax\WooCommerce\Helper::get_product_loop_layout() != '6' ) {
			return $static_css;
		}
