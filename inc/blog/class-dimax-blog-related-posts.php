...
class Related_Posts {
	...
	public function __construct() {
		...
		// Related Post
		add_action( 'dimax_after_close_post_content', array( $this, 'related_post' ), 10 );

		add_action( 'dimax_after_open_related_post_contents', array( $this, 'related_heading' ), 10 );

		add_action( 'dimax_after_open_related_post_contents', array( $this, 'open_related_post' ), 20 );
		add_action( 'dimax_before_close_related_post_contents', array( $this, 'close_related_post' ), 50 );
	}
	...
	public function related_heading() {
		$title      = ! empty( Helper::get_option( 'related_posts_title' ) ) ? Helper::get_option( 'related_posts_title' ) : esc_html__('Related Posts', 'dimax');
	...
	public function open_related_post() {
		...
		echo sprintf( '
					<div class="dimax-post__related-content swiper-container" data-columns="%s">
					<div class="dimax-post__related-content-inner swiper-wrapper">',
