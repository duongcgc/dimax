...
$classess .= Helper::get_option( 'mobile_newsletter_popup' ) ? '' : ' dimax-hide-on-mobile';
    ...
    <div class="modal-content container">
        ...
        <div class="newsletter-popup-wrapper">
            ...
            <a href="#" class="n-close">
				<?php echo apply_filters( 'dimax_newsletter_notices', esc_html__( "Don't show this popup again", 'dimax' ) ) ?>
            </a>
        </div>
    </div>
