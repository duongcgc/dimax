...
$header_background = get_post_meta( \Dimax\Helper::get_post_ID(), 'rz_header_background', true );
$header_background_text = get_post_meta( \Dimax\Helper::get_post_ID(), 'rz_header_text_color', true );

?>
<div class="site-branding">
    <a href="<?php echo esc_url( home_url( '/' ) ) ?>" class="logo <?php echo esc_attr( $class ) ?>">
		<?php if ( 'svg' == $logo_type ) : ?>
            <span class="logo-dark"><?php echo apply_filters('dimax_get_theme_logo', \Dimax\Icon::sanitize_svg( $logo )); ?></span>
		...
		<?php if ( $header_background == 'transparent' && $header_background_text == 'light' ) : ?>
			<?php if ( 'svg' == $logo_type ) : ?>
				<span class="logo-light"><?php echo apply_filters('dimax_get_theme_logo_light',\Dimax\Icon::sanitize_svg( $logo_light )); ?></span>
			<?php elseif ( 'text' == $logo_type ) : ?>
