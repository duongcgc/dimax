...
?>
    ...
    <div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
		...
		<div class="entry-thumbnail">
			<?php
			/**
			 * Hook: dimax_woocommerce_product_quickview_thumbnail
			 *
			 ...
			 *
			 */
			do_action( 'dimax_woocommerce_product_quickview_thumbnail' );
			?>
		</div>

		<div class="summary entry-summary dimax-scrollbar">
			<?php
			/**
			 * Hook: dimax_woocommerce_product_quickview_summary
			 *
			 ...
			 *
			 */
			do_action( 'dimax_woocommerce_product_quickview_summary' );
			?>
		</div>
	</div>
