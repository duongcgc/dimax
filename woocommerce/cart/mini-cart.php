...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<ul class="woocommerce-mini-cart cart_list product_list_widget dimax-scrollbar <?php echo esc_attr( $args['list_class'] ); ?>">
		<?php
					...
					<div class="woocommerce-mini-cart-item__summary">
						<span class="woocommerce-mini-cart-item__name">
                            ...
                            <span class="woocommerce-mini-cart-item__qty hidden">
                                <?php esc_html_e( 'QTY:', 'dimax' ); ?>
	                            <?php echo wp_kses_post( $cart_item['quantity'] ); ?>
                            </span>
						</span>
						<?php echo wc_get_formatted_cart_item_data( $cart_item ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                        <div class="woocommerce-cart-item__qty" data-nonce="<?php echo wp_create_nonce( 'dimax-update-cart-qty--' . $cart_item_key ); ?>">
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message">
		<span>
			<?php esc_html_e( 'Your cart is empty', 'dimax' ); ?>
			<?php echo \Dimax\Icon::get_svg( 'smile' ) ?>
		</span>
		<a class="dimax-button button-outline button-larger" href="<?php echo esc_url (get_permalink( wc_get_page_id( 'shop' ) ) ) ?>"><?php esc_html_e( 'Continue Shopping', 'dimax' ); ?></a>
	</p>
