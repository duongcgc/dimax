	...
	$.fn.quantityDropdown = function( options ) {
		...
		return this.each( function() {
			...
			var $quantityDropdown = $('<div class="qty-dropdown"/>')
				.append('<span class="current"><span class="value">' + current + '</span><span class="dimax-svg-icon "><svg class="svg-icon" aria-hidden="true" role="img" focusable="false" width="10" height="5" viewBox="0 0 10 5" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4.50495 4.82011L0.205241 1.04856C-0.0684137 0.808646 -0.0684137 0.419663 0.205241 0.179864C0.478652 -0.0599547 0.922098 -0.0599547 1.19549 0.179864L5.00007 3.5171L8.80452 0.179961C9.07805 -0.0598577 9.52145 -0.0598577 9.79486 0.179961C10.0684 0.41978 10.0684 0.808743 9.79486 1.04866L5.49508 4.8202C5.35831 4.94011 5.17925 5 5.00009 5C4.82085 5 4.64165 4.94 4.50495 4.82011Z"/></svg></span></span>')
				.append($dropdown)
				.appendTo($quantity);

			$dropdown.wrap( '<div class="qty-options"/>' );
			$quantity.addClass('dimax-quantity-dropdown');
